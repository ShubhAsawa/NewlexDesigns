...
const HeroSection = () => {
  return (
    <section className="relative w-full h-screen flex flex-col items-center justify-center bg-gradient-to-br from-black to-[#E32225] text-white text-center overflow-hidden">
      <motion.h1
      ...
      <motion.p
        className="text-lg md:text-xl text-red-300 font-medium leading-relaxed max-w-3xl"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
