...
const serviceGroups = [
  {
    ...
    desc: "Build a complete, memorable, and strategic brand presence that connects with your audience across every touchpoint. From visuals to voice, we shape identities that stand out and scale with your business.",
    features: [
  ...
  {
    title: "Logo Design",
    desc: "We create distinctive, timeless logos that reflect your brand’s personality and make a strong, lasting impression across every platform.",
    features: [
  ...
  },
  {
    ...
    desc: "Create packaging that captures attention, communicates your value, and turns products into memorable brand experiences users love to share.",
    features: [
  ...
  },
  {
    ...
    desc: "Have a unique idea or a specific creative vision? We bring it to life with custom-designed visuals crafted exactly for your brand’s style and goals.",
    features: [
       "Custom Visual Concepts",
       "Marketing & Social Media Graphics",
       "Print & Digital Creative Assets",
